...
const EmptyMedia = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & { variant?: "default" | "icon" }>(
...
export { Empty, EmptyHeader, EmptyTitle, EmptyDescription, EmptyMedia, EmptyContent }
